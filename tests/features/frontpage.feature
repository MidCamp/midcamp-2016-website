...
Feature: Front page content
  ...
  Scenario: Front page content
    ...
    Given "news" content:
      ...
      | Example news 5            | 0       | 0      | Lorem Ipsum Example 5 | 2017-01-01 8:04am | 2017-01-01 8:04am |
      | Example news 6            | 0       | 0      | Lorem Ipsum Example 6 | 2017-01-01 8:05am | 2017-01-01 8:05am |
    ...
    Then I should see "not going to training"
    Then I break
    Then I should see "Lorem Ipsum Example 1"
    Then I should not see "Lorem Ipsum Example 2"
    Then I should see "Lorem Ipsum Example 3"
    Then I should not see "Lorem Ipsum Example 4"
    #Then I should not see "Lorem Ipsum Example 5"
    #Then I should not see "Lorem Ipsum Example 6"
    Then I break
    Then I should see "Example news 1"
    Then I should not see "Example news 2"
    Then I should see "Example news 3"
